...
class Person:
    ...
    def get_enemy_stats(self):
        ...
        hp_string = "{:<11}".format(str(self.hp) + "/" + str(self.maxhp))

        print("                          _______________________________________________________________________________")
        fixed_name = "{:<9}".format(self.name)
        print(bcolors.BOLD + fixed_name + "    " +
    ...
    def get_stats(self):
        ...
        hp_string = "{:<9}".format(str(self.hp) + "/" + str(self.maxhp))
        mp_string = "{:<9}".format(str(self.mp) + "/" + str(self.maxmp))
